...
eststo i1: qui xi: cluster2  ninv1  LlogK LlogH  i.year i.indcd  LSA2f_qje   LSA2f  Lvol_iret   ,  fcluster(permno)  tcluster(year)
qui xi: reg  ninv1  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd
qui sum    LSA2f if e(sample)==1,d
matrix stoIK_se[1,1]= r(sd) * _b[LSA2f]

qui sum    LSA2f_qje if e(sample)==1,d
matrix stoIK_se[2,1]= r(sd) * _b[LSA2f_qje]

predict pninv1,xb
gen netIK1 =  _b[LSA2f_qje]*LSA2f_qje +  _b[LSA2f]*LSA2f if ~missing(pninv1)
...
eststo i2: qui xi: cluster2  ninv2  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret  i.indcd ,  fcluster(permno)  tcluster(year)
qui xi: reg  ninv2  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd
qui sum    LSA2f if e(sample)==1,d
matrix stoIK_se[1,2]= r(sd) * _b[LSA2f]
qui sum    LSA2f_qje if e(sample)==1,d
matrix stoIK_se[2,2]= r(sd) * _b[LSA2f_qje]

predict pninv2,xb
gen netIK2 =  _b[LSA2f_qje]*LSA2f_qje +  _b[LSA2f]*LSA2f if ~missing(pninv2)
...
eststo i3: qui xi: cluster2  ninv3  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret i.indcd  ,  fcluster(permno)  tcluster(year)
qui xi: reg  ninv3  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd
qui sum    LSA2f if e(sample)==1,d
matrix stoIK_se[1,3]= r(sd) * _b[LSA2f]
qui sum    LSA2f_qje if e(sample)==1,d
matrix stoIK_se[2,3]= r(sd) * _b[LSA2f_qje]

predict pninv3,xb
gen netIK3 =  _b[LSA2f_qje]*LSA2f_qje +  _b[LSA2f]*LSA2f if ~missing(pninv3)
...
eststo i4: qui xi: cluster2  ninv4  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret i.indcd  ,  fcluster(permno)  tcluster(year)
qui xi: reg  ninv4  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd
qui sum    LSA2f if e(sample)==1,d
matrix stoIK_se[1,4]= r(sd) * _b[LSA2f]
qui sum    LSA2f_qje if e(sample)==1,d
matrix stoIK_se[2,4]= r(sd) * _b[LSA2f_qje]

predict pninv4,xb
gen netIK4 =  _b[LSA2f_qje]*LSA2f_qje +  _b[LSA2f]*LSA2f if ~missing(pninv4)
...
eststo i5: qui xi: cluster2  ninv5  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret i.indcd  ,  fcluster(permno)  tcluster(year)
qui xi: reg  ninv5  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd
qui sum    LSA2f if e(sample)==1,d
matrix stoIK_se[1,5]= r(sd) * _b[LSA2f]
qui sum    LSA2f_qje if e(sample)==1,d
matrix stoIK_se[2,5]= r(sd) * _b[LSA2f_qje]

predict pninv5,xb
gen netIK5 =  _b[LSA2f_qje]*LSA2f_qje +  _b[LSA2f]*LSA2f if ~missing(pninv5)
...
eststo i6: qui xi: cluster2  ninv6  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret i.indcd  ,  fcluster(permno)  tcluster(year)
qui xi: reg  ninv6  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd
qui sum    LSA2f if e(sample)==1,d
matrix stoIK_se[1,6]= r(sd) * _b[LSA2f]
qui sum    LSA2f_qje if e(sample)==1,d
matrix stoIK_se[2,6]= r(sd) * _b[LSA2f_qje]

predict pninv6,xb
gen netIK6 =  _b[LSA2f_qje]*LSA2f_qje +  _b[LSA2f]*LSA2f if ~missing(pninv6)
...
eststo i7: qui xi: cluster2  ninv7  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret i.indcd  ,  fcluster(permno)  tcluster(year)
qui xi: reg  ninv7  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd
qui sum    LSA2f if e(sample)==1,d
matrix stoIK_se[1,7]= r(sd) * _b[LSA2f]
qui sum    LSA2f_qje if e(sample)==1,d
matrix stoIK_se[2,7]= r(sd) * _b[LSA2f_qje]

predict pninv7,xb
gen netIK7 =  _b[LSA2f_qje]*LSA2f_qje +  _b[LSA2f]*LSA2f if ~missing(pninv7)
...
eststo i8: qui xi: cluster2  ninv8  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret i.indcd  ,  fcluster(permno)  tcluster(year)
qui xi: reg  ninv8  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd
qui sum    LSA2f if e(sample)==1,d
matrix stoIK_se[1,8]= r(sd) * _b[LSA2f]
qui sum    LSA2f_qje if e(sample)==1,d
matrix stoIK_se[2,8]= r(sd) * _b[LSA2f_qje]

predict pninv8,xb
gen netIK8 =  _b[LSA2f_qje]*LSA2f_qje +  _b[LSA2f]*LSA2f if ~missing(pninv8)
...
eststo e1: qui xi: cluster2  demp1  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret i.indcd ,  fcluster(permno)  tcluster(year)
qui xi: reg  demp1  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd
qui sum    LSA2f if e(sample)==1,d
matrix stoDE_se[1,1]= r(sd) * _b[LSA2f]
qui sum    LSA2f_qje if e(sample)==1,d
matrix stoDE_se[2,1]= r(sd) * _b[LSA2f_qje]

predict pdemp1,xb
gen netDE1 =  _b[LSA2f_qje]*LSA2f_qje +  _b[LSA2f]*LSA2f if ~missing(pdemp1)
...
eststo e2: qui xi: cluster2  demp2  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret  i.indcd  ,  fcluster(permno)  tcluster(year)
qui xi: reg  demp2  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd
qui sum    LSA2f if e(sample)==1,d
matrix stoDE_se[1,2]= r(sd) * _b[LSA2f]
qui sum    LSA2f_qje if e(sample)==1,d
matrix stoDE_se[2,2]= r(sd) * _b[LSA2f_qje]

predict pdemp2,xb
gen netDE2 =  _b[LSA2f_qje]*LSA2f_qje +  _b[LSA2f]*LSA2f if ~missing(pdemp2)
...
eststo e3: qui xi: cluster2  demp3  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd  , fcluster(permno)  tcluster(year)
qui xi: reg  demp3  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd
qui sum    LSA2f if e(sample)==1,d
matrix stoDE_se[1,3]= r(sd) * _b[LSA2f]
qui sum    LSA2f_qje if e(sample)==1,d
matrix stoDE_se[2,3]= r(sd) * _b[LSA2f_qje]

predict pdemp3,xb
gen netDE3 =  _b[LSA2f_qje]*LSA2f_qje +  _b[LSA2f]*LSA2f if ~missing(pdemp3)
...
eststo e4: qui xi: cluster2  demp4  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd  , fcluster(permno)  tcluster(year)
qui xi: reg  demp4  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd
qui sum    LSA2f if e(sample)==1,d
matrix stoDE_se[1,4]= r(sd) * _b[LSA2f]
qui sum    LSA2f_qje if e(sample)==1,d
matrix stoDE_se[2,4]= r(sd) * _b[LSA2f_qje]

predict pdemp4,xb
gen netDE4 =  _b[LSA2f_qje]*LSA2f_qje +  _b[LSA2f]*LSA2f if ~missing(pdemp4)
...
eststo e5: qui xi: cluster2  demp5  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd  , fcluster(permno)  tcluster(year)
qui xi: reg  demp5  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd
qui sum    LSA2f if e(sample)==1,d
matrix stoDE_se[1,5]= r(sd) * _b[LSA2f]
qui sum    LSA2f_qje if e(sample)==1,d
matrix stoDE_se[2,5]= r(sd) * _b[LSA2f_qje]

predict pdemp5,xb
gen netDE5 =  _b[LSA2f_qje]*LSA2f_qje +  _b[LSA2f]*LSA2f if ~missing(pdemp5)
...
eststo e6: qui xi: cluster2  demp6  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd  , fcluster(permno)  tcluster(year)
qui xi: reg  demp6  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd
qui sum    LSA2f if e(sample)==1,d
matrix stoDE_se[1,6]= r(sd) * _b[LSA2f]
qui sum    LSA2f_qje if e(sample)==1,d
matrix stoDE_se[2,6]= r(sd) * _b[LSA2f_qje]

predict pdemp6,xb
gen netDE6 =  _b[LSA2f_qje]*LSA2f_qje +  _b[LSA2f]*LSA2f if ~missing(pdemp6)
...
eststo e7: qui xi: cluster2  demp7  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd  , fcluster(permno)  tcluster(year)
qui xi: reg  demp7  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd
qui sum    LSA2f if e(sample)==1,d
matrix stoDE_se[1,7]= r(sd) * _b[LSA2f]
qui sum    LSA2f_qje if e(sample)==1,d
matrix stoDE_se[2,7]= r(sd) * _b[LSA2f_qje]

predict pdemp7,xb
gen netDE7 =  _b[LSA2f_qje]*LSA2f_qje +  _b[LSA2f]*LSA2f if ~missing(pdemp7)
...
eststo e8: qui xi: cluster2  demp8  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd  , fcluster(permno)  tcluster(year)
qui xi: reg  demp8  LlogK LlogH  i.year   LSA2f_qje   LSA2f  Lvol_iret   i.indcd
qui sum    LSA2f if e(sample)==1,d
matrix stoDE_se[1,8]= r(sd) * _b[LSA2f]
qui sum    LSA2f_qje if e(sample)==1,d
matrix stoDE_se[2,8]= r(sd) * _b[LSA2f_qje]

predict pdemp8,xb
gen netDE8 =  _b[LSA2f_qje]*LSA2f_qje +  _b[LSA2f]*LSA2f if ~missing(pdemp8)
...
esttab i1 i2 i3 i4  i5 i6 i7 i8,   nopar b(3) t(2) nostar keep(LSA2f LSA2f_qje) brackets

esttab e1 e2 e3 e4  e5 e6 e7 e8,   nopar b(3) t(2) nostar keep(LSA2f LSA2f_qje) brackets
...
***************************************************************************
file open outfile using "t2cd_results.txt", write replace
