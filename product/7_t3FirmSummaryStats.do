...
* rescale measure by 1-prob of acceptance (equation3)
* no rescale need here
replace  Af=Af * 100
...
tabstat Af   F0logP F0logY ninv1 demp1 logX,  stats(mean sd p10 p25 p50 p75 p90)  format(%9.1f) column(stat)   
